...
class Experiment:
    ...
    def run(self):
        ...
        for i_episode in itertools.count(1):
            ...
            if i_episode % 500 == 0:
                PATH_policy = "./saved_model/policy_" + str(self.exp_cfg.env_name) \
                    + "_" + str(self.exp_cfg.method_name) + "_epi" + str(i_episode) + \
                        "_seed" + str(self.exp_cfg.seed) + ".pkl"
                PATH_critic = "./saved_model/critic_" + str(self.exp_cfg.env_name) \
                    + "_" + str(self.exp_cfg.method_name) + "_epi" + str(i_episode) + \
                        "_seed" + str(self.exp_cfg.seed) + ".pkl"
                torch.save(self.agent.policy, PATH_policy)
                torch.save(self.agent.critic, PATH_critic)
                PATH_safety_critic = "./saved_model/safety_critic_" + str(self.exp_cfg.env_name) \
                    + "_" + str(self.exp_cfg.method_name) + "_epi" + str(i_episode) + \
                        "_seed" + str(self.exp_cfg.seed) + ".pkl"
